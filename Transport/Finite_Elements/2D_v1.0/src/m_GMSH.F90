module m_GMSH
    ...
    implicit none
    private
    public :: ParseMesh, derive_case_nametag
...
contains
    ...
    subroutine ParseMesh(filename, FE, mesh, write_files)
        character(len=*), intent(in)  :: filename
        ...
        do i = 1, nelem
            ...
            case (9) ! VTK_QUAD
                ...
                if (npe == 4) then
                    ...
                    mesh%elems(iq, 4) = connectivity(start + 3) + 1
                    mesh%elems(iq, 3) = connectivity(start + 4) + 1
                else
                    do j = 1, npe
