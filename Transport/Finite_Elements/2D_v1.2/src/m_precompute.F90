        ...
        do ee = 1, mesh%n_elems
            ...
            do i = 1, n_patch_basis
                if (mesh%elems(ee, i) > 0) then
                    ...
                    if (allocated(mesh%weights)) weights_local(i) = mesh%weights(mesh%elems(ee, i))
                end if
            end do
        ...
        do mm = 1, sn_quad%n_angles
            ...
            do ee = 1, mesh%n_elems
                ...
                do g = 1, n_groups
                    ...
                    call check_nan_matrix(mesh%elem_mass_matrix(1:n_patch_basis, 1:n_patch_basis, ee), "elem_mass_matrix", "Precompute_All_Local_LU, Elem "//int_to_str(ee)//", Group "//int_to_str(g))
                    ...
                    if (info /= 0) then
                        write(*,*) "FATAL: LU Factorization failed (Singular Matrix) in Elem:", ee, " Angle:", mm, " info:", info
                        stop
                    end if
