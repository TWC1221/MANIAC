program fem_1d
  ...
  do iter = 2, 1000
    ...
    call integrate_scalar_over_mesh(mats, elem_mat_map, FE, quad, Nq, dNq, flux_prev, fission_integrand, keff_den, adjoint, geom)
    ...
    call integrate_scalar_over_mesh(mats, elem_mat_map, FE, quad, Nq, dNq, flux_new, fission_integrand, keff_num, adjoint, geom)
    K_eff(iter) = K_eff(iter-1) * (keff_num / keff_den)

    call integrate_scalar_over_mesh(mats, elem_mat_map, FE, quad, Nq, dNq, flux_new, production_integrand, prod_total, adjoint, geom)
