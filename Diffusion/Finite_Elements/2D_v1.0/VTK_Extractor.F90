program VTK_NthOrder_Boundary
    ...
    infile = "../C5G7surf_2_1_f_MOD.vtk"
    outfile = "../C5G7surf_2_1_f_p.vtk"
    ...
    ! New Parser looking specifically for CellEntityIDS in CELL_DATA
...
contains
    ...
    subroutine parse_cell_entity_ids(u, ids, n)
        ...
        do while (.true.)
            ...
            ! Match the specific keyword for material/volume IDs
            if (index(line, "CellEntityIds") > 0) then
