...
! 12/02/2026    T. Charlton      Quad Generation via PetSC             -!
!-----------------------------------------------------------------------!
...
subroutine HexahedralQuadrature(Quad, QuadBound, IntegOrder)
    ...
    allocate(Quad%Xi(IntegOrder**3))
    allocate(Quad%Eta(IntegOrder**3))
    allocate(Quad%Zeta(IntegOrder**3))
    allocate(Quad%W(IntegOrder**3))
